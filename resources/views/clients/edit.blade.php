...
@section('content')
    <div class="container">
        <div class="buttons">
            ...
            <a href="{{route('clients_show')}}" class="btn btn-primary ">Назад</a>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Добавление клиента в базу</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('client_store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="middle_name" class="col-md-4 col-form-label text-md-end">Адресс</label>
                                <div class="col-md-6">
                                    <input id="middle_name" type="text" class="form-control " name="adress"
                            ...
                            <div class="row mb-3">
                                <label for="phone" class="col-md-4 col-form-label text-md-end">Email</label>
                                <div class="col-md-6">
                                    <input id="phone" type="email" class="form-control " name="email"
                                           value="{{ old('phone') }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
